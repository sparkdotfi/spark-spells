...
contract ProtocolV3TestBase is CommonTestBase {
  ...
  function _e2eTestBorrowRepayWithdraw(
    ...
    _assertReserveChange(beforeReserve, afterReserve, int256(amount), 4 hours);
    ...
    uint256 timePassed = collateralConfig.underlying == borrowConfig.underlying ? 1 hours : 9 hours;
