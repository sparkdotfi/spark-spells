...
abstract contract SparkLiquidityLayerTests is SpellRunner {
    ...
    function _testControllerUpgrade(address oldController, address newController) internal {
        ...
        assertEq(controller.hasRole(relayerRole, Ethereum.ALM_BACKSTOP_RELAYER_MULTISIG), false);  // ALM_RELAYER address same on all chains
        ...
        assertEq(controller.hasRole(relayerRole, Ethereum.ALM_BACKSTOP_RELAYER_MULTISIG), true);  // ALM_RELAYER address same on all chains
