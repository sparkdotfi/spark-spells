...
contract SparkBase_20251113 is SparkPayloadBase {
    ...
    function execute() external {
        ...
        ForeignController(NEW_ALM_CONTROLLER).setMaxExchangeRate(Base.MORPHO_VAULT_SUSDC, 1e36, 1e36);
        ForeignController(NEW_ALM_CONTROLLER).setMaxExchangeRate(Base.FLUID_SUSDS,        1e36, 1e36);
    }
