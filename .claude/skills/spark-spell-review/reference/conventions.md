...
Reference for reviewing spell PRs. Everything here is verifiable in the repo — if the code you are
reviewing deviates from a convention below, either the convention has evolved (check recent
`archive/` spells) or you have found a finding.
